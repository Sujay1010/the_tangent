...
if (canvas) {
  ...
  function drawTangent() {
    ...
    // safe, on-screen positioning regardless of aspect ratio
    const margin = 60;
    ...
    ctx.strokeStyle = 'rgba(155,140,245,0.6)';
    ctx.lineWidth = 2.5;
    ctx.lineCap = 'round';
    ctx.stroke();
    ...
    grad.addColorStop(0.5, 'rgba(155,140,245,1)');
    ...
    ctx.strokeStyle = 'rgba(123,92,240,0.7)';
    ctx.lineWidth = 1.5;
    ctx.stroke();
  }
